...
The PAUSE user `MICVU` indexing-permission blocker from 2016-2021 releases (tracked as `HAC-003`) was resolved by Michael on 2026-08-17; every release since (v1.05 through v1.25, as of 2026-08-19) has shipped and indexed cleanly.
